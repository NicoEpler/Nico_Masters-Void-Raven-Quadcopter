...
>>>>>>> 33344ac41e9d32f86297f60339b8ff815b1ea25b
...
=======
# Setting up Raspberry Pi with RGBD Camera
>>>>>>> 33344ac41e9d32f86297f60339b8ff815b1ea25b
...
=======
	...
	2. During Git Setup in "ROS 2 and uXRCE-DDS", also add:
```Shell
git config --global user.name "DronePi"
git config --global user.email "2390712@sun.ac.za"
git config --global --list
```
	3. Start uXRCE_DDS agent on RBPi using:
```Shell
sudo MicroXRCEAgent serial --dev /dev/ttyAMA0 -b 921600
```
	4. Now that both agent and client are running, you should see activity on both the MAVLink console and the RPi terminal. You can view the available topics using the following command on the RPi:
```Shell

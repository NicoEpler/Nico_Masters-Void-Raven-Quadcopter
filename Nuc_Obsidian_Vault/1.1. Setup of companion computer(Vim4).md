...
ros2 topic list
```
6. for a successful communication link establishment, you should see lots of topics starting with "/fmu/.........". If you dont see this, check that your "ROS_DOMAIN_ID" in bash.rc onPi and  UXRCE_DDS_DOM_ID parameter on FC are the same (preferably 0). If still not work, also check local host

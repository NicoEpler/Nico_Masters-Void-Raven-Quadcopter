...
6. for vim only, you have to manually mount the sd card and give permissions to user (not root only):
```Shell
...
10. connect monitor
11. transfer rosbag and delete on Vim
```Shell

...
8. For RobMech:
	...
	4. Nicely visualize point cloud??? (check it the [FFmpeg method](https://spectacularai.github.io/docs/sdk/wrappers/oak.html#spectacularAI.depthai.Session) here works)
	5. Add SpecAI VIO to EKF2 and check performance
